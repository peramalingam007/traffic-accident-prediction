    ...
    try:
        ...
        for color_name, (lower, upper) in colors.items():
            try:
                ...
                # Optional: Display the result (uncomment if needed)
        ...
        # Optional: Display original image (uncomment if needed)
...
def main():
    # Example usage
    image_path = "Colour_detection/image.jpg"  # Update this path to your image
